<template>
<div class="flex bg-brand-lightblue/10 xxl:p-10 xl:p-10 sm:p-10 xs:p-12 xxs:p-12  justify-center items-center">
    <div class=" flex-col xxl:space-y-1 xl:space-y-1 xxs:space-y-0">
        <!-- Send message title -->
