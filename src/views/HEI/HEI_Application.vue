    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
      <div class="flex flex-row space-x-4 pl-5 py-4">
        ...
        <div class="dropdown flex">
          <select
            class="select select-ghost select-sm w-full max-w-xs border-none"
            style="outline: none"
            v-model="sort_type"
      ...
      <table class="w-full text-sm text-left text-gray-500">
        ...
        <tbody>
          <tr
            v-for="table in searchApplication"
            :key="table"
          ...
          >
            ...
            <td class="px-6 py-4">
              <div
                ...
                class="btn-sm1 p-2 font-normal approval rounded-md"
              >
                {{ table.status }}
              </div>
              <div
                v-else-if="table.status === 'For Revision'"
                class="btn-sm1 p-2 font-normal revision rounded-md"
              >
                {{ table.status }}
              </div>
              ...
              <div
                ...
                class="btn-sm1 p-2 font-normal completed rounded-md"
              >
                {{ table.status }}
              </div>
            </td>
            <td class="px-6 py-4 text-right">
              ...
              >
                <a
                  v-if="statusChecker(table.status)"
                  href="#"
