...
<div>
    <div class="mx-3">
        ...
        <form @submit.prevent="submitPayment" class="m-5">
            ...
            <div v-if="paymentStatus == 'Rejected'" class="flex p-4 mb-4 text-sm text-red-700 bg-red-100 rounded-lg dark:bg-red-200 dark:text-red-800" role="alert">
                ...
                <div>
                    <span class="">Payment has been rejected: {{rejectionReason}}</span>
                </div>
            </div>
...
export default {
    ...
    mounted: async function () {
        ...
        if (flag === 0) {
            ...
            this.rejectionReason = application.get("rejectionReason");
