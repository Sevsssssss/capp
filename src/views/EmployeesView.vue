<template>
  ...
  <div v-else class="" style="padding: 10px">
    <div class="overflow-x-auto shadow-lg rounded-lg" style="margin: 11px">
      <div class="top-row flex flex-row" style="justify-content: space-between">
        <div class="search-container">
          <input
            ...
            name="search"
            placeholder="Search"
            class="search-input input rounded-lg text-sm focus:outline-none"
            v-model="search"
          />
        ...
        <div class="flex flex-row">
          ...
          <button
            @click="addEmployee()"
            class="btn btn-primary1 bg-brand-darkblue"
            style="width: 180px"
          >
      ...
      <table class="hei-table table-normal w-full">
        ...
        <tbody class="hei-table">
          <tr class="hei-table bg-grey-500">
            <th
              class="font-semibold text-grey-200"
      ...
      <!-- Footer -->
      <div
        class="table-footer flex flex-row"
