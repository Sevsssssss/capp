        ...
        <div class="flex flex-row" style="justify-content: space-between">
          <div class="form-control mr-3 w-full">
            ...
            <input
              ...
              v-model="v$.applicationTypeName.$model"
            />
            ...
            <label class="label">
              <span
                ...
                :class="{
                  'text-error': validationStatus(v$.applicationTypeName),
                }"
                v-if="validationStatus(v$.applicationTypeName)"
              >
          ...
          >
            ...
            <button
              data-tip="Remove Requirement"
              @click="pop"
              class="btn tooltip tooltip-left btn-outline hover:bg-brand-red/60"
            >
              <svg style="width: 24px; height: 24px" viewBox="0 0 24 24">
            ...
            <div class="flex flex-row justify-center items-center">
              <div class="form-control w-full mr-3">
                ...
                <input
                  ...
                  :class="{
                    'input-error': validationStatus(v$.applicationReq),
                  }"
                ...
                <label class="label">
                  <span
                    class="label-text-alt"
                    :class="{
                      'text-error': validationStatus(v$.applicationReq),
                    }"
                    v-if="validationStatus(v$.applicationReq)"
                  >
