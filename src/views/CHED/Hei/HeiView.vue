        ...
        <div class="flex space-x-4 pl-5 py-4">
          ...
          <div class="flex flex-row">
            ...
            <div class="month-sort flex flex-row">
              <select
                class="font-normal rounded-md select select-ghost select-sm w-full max-w-xs"
                style="outline: none"
                id="hei_sort"
                v-model="sort_type"
                @change="filterHEI()"
        ...
        <div class="flex flex-row">
          ...
          <div class="h-fit pt-3 items-center">
            <label
              @click="csvHei()"
              type="button"
              class="flex items-center text-white bg-brand-darkblue hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            >
              <svg
                style="fill: white"
                xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="modal">
      <div class="modal-box relative rounded-md text-left">
        ...
        <div class="modal-action">
          ...
          >
          <label
            class="btn btn-sm bg-red-500 hover:bg-red-600 rounded-md border-none"
            >Delete</label
          >
        </div>
      </div>
