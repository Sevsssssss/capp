...
<div class="m-3">
    <div class="flex flex-row justify-between">
        <div class="flex flex-col p-4 text-left space-y-2">
            ...
            <div class="font-normal text-sm uppercase">APPLICATION FOR: <span class="font-semibold">{{type}}</span></div>
        </div>
        <div class="flex flex-col">
            <div class="text-left p-4 pr-6 space-y-2">
                <div class="font-semibold text-md uppercase">APPLICATION STATUS - <span class=""> {{status}}</span></div>
                <div class="font-semibold text-sm">Date Applied: <span class="font-normal">{{dateApplied}}</span></div>
            </div>
            <!-- <p>ID Number: {{id}}</p> -->
        </div>
    </div>
...
<div class="modal">
    <div class="modal-box relative rounded-md text-left">
        ...
        <p class="py-2 text-sm">You've been selected for a chance to get one year of subscription to use Wikipedia for free!</p>
        <!-- Filter -->
        ...
        <div class="modal-action">
            <label for="for-approval" class="btn btn-sm pb-6 text-blue-700 bg-transparent border border-blue-700 hover:bg-white">Cancel</label>
            <label class="btn btn-sm pb-6 bg-blue-700 hover:bg-blue-800 border-none">Assign</label>
        </div>
    </div>
</div>
...
<div class="modal">
    <div class="modal-box relative rounded-md text-left">
        ...
        <div class="modal-action">
            <label for="for-evaluation" class="btn btn-sm pb-6 text-blue-700 bg-transparent border border-blue-700 hover:bg-white">Cancel</label>
            <label class="btn btn-sm pb-6 bg-blue-700 hover:bg-blue-800 border-none">Assign</label>
        </div>
    </div>
</div>
