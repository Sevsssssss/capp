...
<div class="m-3">
    <div class="flex flex-row p-2 justify-end">
        ...
        <div class="flex space-x-2 pr-2">
            <!-- add -->
            <button @click="editEvalIns()" class="
            btn btn-md
            bg-brand-darkblue
            hover:bg-brand-blue
            border-none
    ...
    <div class="overflow-x-auto shadow-lg rounded-lg m-3 p-5 ">
        ...
        <div class="text-center p-5">
            <div class="font-semibold">REVISED PROCESSING FORM FOR MONITORING AND EVALUATION</div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="font-light space-y-3">
                                ...
                                <div> 3. holder of Master of Doctor of Library and Information
                                    Science, or With appropriate or related Specialization
                                    (Information Systems, Educ. Tech., Technology Mgmt. Info</div>
                                <div> 4. With at least 5 years of very satisfactory teaching
                                    experience.</div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th></th>
                            <td class="font-medium flex">Teaching Load of the Dean/ Program</td>
                            <td class="font-light space-y-3">
                                <div>
                                    max. of 12 units</div>
                                <div>
