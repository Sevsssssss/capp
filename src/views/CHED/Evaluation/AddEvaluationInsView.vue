...
<div class="m-3">
    ...
    <div class="overflow-x-auto shadow-lg rounded-lg p-8 w-full">
        ...
        <div class="table-footer flex flex-row" style="justify-content: center">
            <div class="flex flex-row pt-5">
                ...
                <button @click="saveEvalForm()" class="btn btn-margin submit border-none bg-brand-darkblue hover:bg-brand-blue">
                    Create
                </button>
            </div>
        </div>
