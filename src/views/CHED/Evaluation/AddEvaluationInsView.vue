    ...
    <div class="overflow-x-auto shadow-lg rounded-lg p-5" style="margin: 11px">
      <div class="flex flex-row" style="justify-content: space-between">
        <div class="form-control mr-3 w-full">
          <label class="label"><span class="label-text">CMO No.*</span></label
          ><input
            type="text"
      ...
      >
        <div
          class="mx-5 top-row flex flex-row"
...
export default {
  ...
  methods: {
    ...
    addCategory() {
      var categoryId = this.categories.length + 1;
      var category = [
        {
          id: categoryId,
          subcategoryC: 0,
    ...
    getSubCategories(thisCategory) {
      ...
      for (var i = 0; i < this.subCategories.length; i++) {
        if (this.subCategories[i].subcategory[0].catId === categoryId) {
