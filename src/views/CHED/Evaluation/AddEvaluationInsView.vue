    ...
    <div class="overflow-x-auto shadow-lg rounded-lg p-5" style="margin: 11px">
      ...
      >
        <div class="flex flex-row px-2" style="justify-content: space-between">
          ...
          <div
            class="flex flex-row"
            style="justify-content: space-between; flex: 1 1 auto"
          >
        ...
        <div
          class="flex flex-row pt-2 center"
          style="justify-content: space-between"
        >
          <div class="px-7">SUB-CATEGORY</div>
          <div class="mt-5" style="text-align: right">
            <button
              class="btn mx-2 bg-brand-darkblue hover:bg-brand-blue border-none"
        ...
        >
          <div v-if="viewSubCat()">
            <div class="px-8">
              ...
              >
              <div
                class="form-control w-full mr-3 flex flex-row"
                style="justify-content: space-between"
              >
                <input
            ...
            <div
              class="flex flex-row pt-5 px-10 center"
              style="justify-content: space-between"
            >
              <div class="">ITEMS:</div>
              <div>
            ...
            <div v-for="item in subcategory.items" :key="item" class="my-3">
              <div class="flex flex-row px-10">
                <label class="label"
                  ><span class="label-text">Item {{ item.id }}</span></label
                >
                <input
                  v-model="item.Item"
                  type="text"
      ...
      <div class="table-footer flex flex-row" style="justify-content: center">
        <div class="flex flex-row pt-5">
          <button class="btn btn-margin btn-outline">Cancel</button
          ><button
            @click="saveEvalForm()"
  ...
  methods: {
    ...
    async saveEvalForm() {
      ...
      try {
        ...
        if (
          confirm(
            "Application Type added. Would you like to add another Evaluation Instrument?"
          )
        ) {
