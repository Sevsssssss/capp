    ...
    <div class="overflow-x-auto shadow-lg rounded-lg p-5" style="margin: 11px">
        ...
        <div class="table-footer flex flex-row" style="justify-content: center">
            <div class="flex flex-row pt-5">
                <button @click="$router.go(-1)" class="btn btn-margin btn-outline">Cancel</button><button class="btn btn-margin submit bg-brand-darkblue hover:bg-brand-blue">
                    Create
                </button>
            </div>
        </div>
