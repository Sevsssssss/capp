    ...
    return {
      ...
      tables: [
        ...
        },
        {
          programName: "BACHELOR OF CULTURE & ARTS EDUCATION",
          description:
            "has minim elitr intellegat. Mea aeterno eleifend antiopam ad, nam no suscipit quaerendum.",
        },
        {
          programName: "BACHELOR OF CULTURE & ARTS EDUCATION ",
          description:
            "minim elitr intellegat. Mea aeterno eleifend antiopam ad, nam no suscipit quaerendum.",
        },
        {
          programName: "BACHELOR OF CULTURE & ARTS EDUCATION ",
          description:
            "elitr intellegat. Mea aeterno eleifend antiopam ad, nam no suscipit quaerendum.",
        },
        {
          programName: "BACHELOR OF CULTURE & ARTS EDUCATION ",
          description:
