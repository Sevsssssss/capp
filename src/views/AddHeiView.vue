    ...
    <div class=" card justify-center items-center space-x-3 bg-brand-white shadow-lg rounded-lg m-3 p-6">
        <div class="card-body">
            <div class="flex flex-row">
                ...
                <h2 class="card-title">ADD HEI ACCOUNT</h2>
            </div>
            <h6 style="text-align: start; font-weight: 500">
            ...
            <div class="flex flex-row">
                <div class="form-control w-full">
                    ...
                    <input type="text" placeholder="Enter Code" class="input input-bordered w-full" />
                </div>
            ...
            <div class="flex flex-row">
                ...
                <button class="btn btn-margin btn-wide">Add HEI</button>
            </div>
        </div>
    </div>
</div>
