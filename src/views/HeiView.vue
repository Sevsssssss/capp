...
<div class="p-5">
    <div class="grid grid-cols-4">
        <div class="space-x-3 bg-brand-white shadow-lg rounded-lg m-3 p-6 hover:shadow-xl" v-for="data in datas" :key="data">
            <div class="flex flex-col text-left">
                <div class="flex flex-row">
                    ...
                    <div class="label-text font-semibold text-grey-300 pl-2">{{ data.title }}</div>
                </div>
                <br>
                <div class="text-2xl font-semibold text-grey-300 ">{{ data.num }}</div>
            </div>
        </div>
    </div>
    <div class="overflow-x-auto shadow-lg rounded-lg m-3">
        <table class="text-left table-normal w-full">
            <!-- head -->
            <thead>
                <tr>
                    <th>
