            ...
            <template v-slot:footer>
                <div class="p-5 grid grid-cols-1 content-center space-y-4" :class="collapsed ? '' : 'hidden'">
                    <div class="flex flex-row justify-center">
                        <button @click="accountDetails()" class="flex space-x-1 mr-3 justify-center items-center focus:outline-none hover:pr-1 text-blue-500 ">
...
export default {
    ...
    mounted: async function () {
        ...
        applicationSub.on('create', (object) => {
            console.log("Application Created Notif" + object.attributes);
        });
